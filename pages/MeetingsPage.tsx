...
const MeetingsPage: React.FC<MeetingsPageProps> = ({ meetings }) => {
  ...
  return (
    <div>
        <header className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Single Meeting Analysis</h1>
            <p className="mt-1 text-lg text-gray-600 dark:text-gray-400">Dive deep into individual meeting transcripts for sentiment and participation insights.</p>
        </header>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <aside className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg self-start">
